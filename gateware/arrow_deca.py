...
class ArrowDECAClockAndResetController(Elaboratable):
    ...
    def elaborate(self, platform):
        ...
        m.submodules.pll = pll = Instance("ALTPLL",
...
class ArrowDECAPlatform(IntelPlatform, LUNAPlatform):
    ...
    resources   = [
        ...
        *SwitchResources(
        ...
        #TODO: was it already specified somewhere?
        Resource("phy", 0,
            Subsignal("tx_clk", Pins("T5", dir="i")),
            Subsignal("txd",    Pins("U2 W1 N9 W2", dir="o")),
            Subsignal("tx_en",  Pins("P3", dir="o")),
            Subsignal("rx_clk", Pins("T6", dir="i")),
            Subsignal("rxd",    Pins("U5 U4 R7 P8", dir="i")),
            Subsignal("rx_dv",  Pins("P4", dir="i")),
            Subsignal("rx_er",  Pins("V1", dir="i")),
            Subsignal("col",    Pins("R4", dir="i")),
            Subsignal("crs",    Pins("P5", dir="i")),
            Subsignal("resetn", Pins("R3", dir="o")),
            Subsignal("mdio",   Pins("N8", dir="io")),
